...
{
    if(nHeight > 1500000) return  70000 * COIN;
    if(nHeight > 1400000) return  65000 * COIN;
    if(nHeight > 1300000) return  60000 * COIN;
    if(nHeight > 1200000) return  55000 * COIN;
    if(nHeight > 1100000) return  50000 * COIN;
    if(nHeight > 1000000) return  45000 * COIN;
    if(nHeight > 900000) return  40000 * COIN;
    if(nHeight > 800000) return  35000 * COIN;
    if(nHeight > 700000) return  32000 * COIN;
    if(nHeight > 600000) return  29000 * COIN;
    if(nHeight > 500000) return  26000 * COIN;
    if(nHeight > 400000) return  23000 * COIN;
    if(nHeight > 350000) return  20000 * COIN;
    if(nHeight > 300000) return  17000 * COIN;
    if(nHeight >  250000) return  15000 * COIN;
    if(nHeight >  200000) return  13000 * COIN;
    if(nHeight >  150000) return  11000 * COIN;
    if(nHeight >  100000) return   9000 * COIN;
    if(nHeight >  50000) return   7000 * COIN;
...
{
    if(nHeight > 1500000) return  25 * COIN;
    if(nHeight > 1400000) return  30 * COIN;
    if(nHeight > 1300000) return  35 * COIN;
    if(nHeight > 1200000) return  40 * COIN;
    if(nHeight > 1100000) return  30 * COIN;
    if(nHeight > 1000000) return  25 * COIN;
    if(nHeight > 900000) return  20 * COIN;
    if(nHeight > 800000) return  20 * COIN;
    if(nHeight > 700000) return  15 * COIN;
    if(nHeight > 600000) return  15 * COIN;
    if(nHeight > 500000) return  20 * COIN;
    if(nHeight > 400000) return  25 * COIN;
    if(nHeight > 350000) return  30 * COIN;
    if(nHeight > 300000) return  25 * COIN;
    if(nHeight > 250000) return  20 * COIN;
    if(nHeight > 200000) return  18 * COIN;
    if(nHeight > 150000) return  16 * COIN;
    if(nHeight > 100000) return  15 * COIN;
    if(nHeight >  50000) return  14 * COIN;
    if(nHeight >   1000) return  12 * COIN;
    if(nHeight > 2) return  10 * COIN;
...
{
    if(nHeight > 1200000) return GetBlockValue(nHeight) * 70 / 100;
...
bool CMasternodeBroadcast::CheckInputsAndAdd(int& nDoS)
{
    ...
    // should be at least not earlier than block when 1000 EVET tx got MASTERNODE_MIN_CONFIRMATIONS
    ...
    if (mi != mapBlockIndex.end() && (*mi).second) {
        ...
        int nConfHeight = pMNIndex->nHeight + MASTERNODE_MIN_CONFIRMATIONS - 1; // block for 1000 EVET tx -> 1 confirmation
