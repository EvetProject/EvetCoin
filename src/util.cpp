...
const char * const PIVX_CONF_FILENAME = "evet.conf";
const char * const PIVX_PID_FILENAME = "evet.pid";
...
{
// Windows < Vista: C:\Documents and Settings\Username\Application Data\evet
// Windows >= Vista: C:\Users\Username\AppData\Roaming\evet
// Mac: ~/Library/Application Support/evet
// Unix: ~/.evet
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Evet";
#else
    fs::path pathRet;
    ...
    std::map<std::string, std::vector<std::string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty evet.conf if it does not exist
    ...
    for (boost::program_options::detail::config_file_iterator it(streamConfig, setOptions), end; it != end; ++it) {
        // Don't overwrite existing settings so command line settings override evet.conf
