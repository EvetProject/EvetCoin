...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* EVET features */
        {"evet", "listmasternodes", &listmasternodes, true },
        {"evet", "getmasternodecount", &getmasternodecount, true },
        {"evet", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"evet", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"evet", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"evet", "masternodecurrent", &masternodecurrent, true },
        {"evet", "startmasternode", &startmasternode, true },
        {"evet", "createmasternodekey", &createmasternodekey, true },
        {"evet", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"evet", "listmasternodeconf", &listmasternodeconf, true },
        {"evet", "getactivemasternodecount", &getactivemasternodecount, true },
        {"evet", "getmasternodestatus", &getmasternodestatus, true },
        {"evet", "getmasternodewinners", &getmasternodewinners, true },
        {"evet", "getmasternodescores", &getmasternodescores, true },
        {"evet", "mnsync", &mnsync, true },
        {"evet", "spork", &spork, true },
...
{
    return "> evet-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:16060/\n";
}
