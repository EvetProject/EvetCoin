    ...
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of EVET earned via Staking & Masternodes"));
	...
	ui->labelAmountMNRewards->setText("0 EVET");
...
void DashboardWidget::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("EVET")
    updateDisplayUnit();
}
...
bool DashboardWidget::loadChartData(bool withMonthNames)
{
    ...
    chartData->amountsByCache = getAmountBy(); // pair EVET
...
void DashboardWidget::onChartRefreshed()
{
    ...
    set0->setColor(QColor(0, 209, 255));
