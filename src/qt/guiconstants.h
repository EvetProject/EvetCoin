...
/* Evet GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Evet"
#define QAPP_ORG_DOMAIN "evet.org"
#define QAPP_APP_NAME_DEFAULT "Evet-Qt"
#define QAPP_APP_NAME_TESTNET "Evet-Qt-testnet"
