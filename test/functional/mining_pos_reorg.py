...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        # verify that nodes have the expected EVET supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check EVET supply at the beginning
        # ------------------------------------------
        # EVET supply: block rewards minus burned fees for minting
        ...
        # Verify that EVET supplies were properly updated after the spends and reorgs
        self.log.info("Check EVET supply...")
