...
"""Verify that starting evet with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start evet with -? for help text")
        ...
        self.log.info("Start evet with -version for version information")
