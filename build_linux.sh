...
# Create zip file of binaries
	cp EVET/src/evetd EVET/src/evet-cli EVET/src/evet-tx EVET/src/qt/evet-qt .
	zip EVET-$(git describe --abbrev=0 --tags | sed s/v//)-Linux.zip evetd evet-cli evet-tx evet-qt
	rm -f evetd evet-cli evet-tx evet-qt
