Contributing to Evet Core
============================

The Evet Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Evet Core project, and is not to be
confused with overall Evet Network Protocol consensus changes.

Whether a pull request is merged into Evet Core rests with the project merge
...
Patches that change Evet consensus rules are considerably more involved than
...
Where a patchset proposes to change the Evet consensus, it must have been
...
The project leader is the release manager for each Evet Core release.
