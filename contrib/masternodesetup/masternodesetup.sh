...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='evet.conf'
CONFIGFOLDER='/root/.evet'
COIN_DAEMON='evetd'
COIN_CLI='evet-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/decenomy/EVET/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
