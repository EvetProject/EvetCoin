...
#define MyAppName "Evet Core"
#define MyAppPublisher "2022 DECENOMY Core Developers"
#define MyAppURL "https://evet.ink"
#define MyAppExeName "evet-qt.exe"
#define MyAppExtraData "https://explorer.decenomy.net/bootstraps/EVET/bootstrap.zip"
...
[Files]
Source: ".\package\evet-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Evet\Evet-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Evet\Evet-Qt,strDataDir|{userappdata}\Evet\}');
  Result := True;
end;
